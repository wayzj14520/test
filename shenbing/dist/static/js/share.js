...
if(getQueryString('channelCodeSe')=='dmFsbGV5Ozkx'||getQueryString('channelCodeSe')=='ZnV0dXJlOzM3' || getQueryString('channelCodeSe')=='Y29tbW9uOzE3'){
    setCookie('channelCodeSec',getQueryString('channelCodeSe'))
    sessionStorage.setItem("channelCodeSec", getQueryString('channelCodeSe'));
}

if(getQueryString('qrcodeId')&&getQueryString('qrcodeId')!=''){
    sessionStorage.setItem("qrcodeId", getQueryString('qrcodeId'));
}
...
if(window.location.href.indexOf('/creatCode?')!=-1&&getQueryString('qrcodeId')){
    var qrcode_id=getQueryString('qrcodeId')
    host_wxshare="https://"+window.location.host+"/#/entryNumber/index?qrcodeId="+qrcode_id
 
}

if(sessionStorage.getItem("channelCodeSec")=='dmFsbGV5Ozkx'||sessionStorage.getItem("channelCodeSec")=='ZnV0dXJlOzM3'){
    var qrcode_id2=sessionStorage.getItem("qrcodeId")
    console.log('share.js===>', qrcode_id2)
    if(getQueryString('qrcodeId')&&getQueryString('qrcodeId')!=""){
    ...
    if(!qrcode_id2||qrcode_id2==''){
        ...
        host_wxshare="https://"+window.location.host+"/#/entryNumber/index?qrcodeId="+qrcode_id2+"&channelCodeSe=" +sessionStorage.getItem("channelCodeSec")

    }
   
 }
 if(window.location.href.indexOf('#/entryNumber/information?')>-1&&(sessionStorage.getItem("channelCodeSec")=='dmFsbGV5Ozkx'||sessionStorage.getItem("channelCodeSec")=='ZnV0dXJlOzM3')){
    var qrcode_id2=getQueryString('qrcodeId')
