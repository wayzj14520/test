UE.registerUI('wordFormat', function (editor, uiName) {
    ...
    var dialog = new UE.ui.Dialog({
        ...
        iframeUrl: getRootPath()+'/js/extends/ueditor_1.4.3.3/wordFormat.html',
        //需要指定当前的编辑器实例
        editor: editor,
        //指定dialog的名字
        name: uiName,
    ...
    var btn = new UE.ui.Button({
        ...
        cssRules: 'background: url("'+getRootPath()+'/js/extends/ueditor_1.4.3.3/word-icon.png")!important; background-size: 20px 20px',
        //点击时执行的命令
        onclick: function () {
            //渲染dialog
            dialog.render();
